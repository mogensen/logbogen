...
for climbType in "${ClimbingArray[@]}"; do
  echo Archievement for: $climbType
  ...
  $CONVERT -size 1024x1024  xc:none \
    ...
    /imgs/archievements/${climbType}-0.png
  ...
  $CONVERT -size 1024x1024  xc:none \
    ...
    /imgs/stars/star_216_gray.png      -composite \
    /imgs/stars/star_288_gray.png      -composite \
    /imgs/archievements/${climbType}-1.png
  ...
  $CONVERT -size 1024x1024  xc:none \
    ...
    /imgs/stars/star_216_gray.png      -composite \
    /imgs/stars/star_288_gray.png      -composite \
    /imgs/archievements/${climbType}-2.png
  ...
  $CONVERT -size 1024x1024  xc:none \
    ...
    /imgs/stars/star_216_gray.png      -composite \
    /imgs/stars/star_288_gray.png      -composite \
    /imgs/archievements/${climbType}-3.png
  ...
  $CONVERT -size 1024x1024  xc:none \
    ...
    /imgs/stars/star_288_gray.png      -composite \
    /imgs/archievements/${climbType}-4.png
  ...
  $CONVERT -size 1024x1024  xc:none \
    ...
    /imgs/archievements/${climbType}-5.png
done
