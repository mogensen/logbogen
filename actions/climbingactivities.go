...
func GetLocation(c buffalo.Context, climbingactivity *models.Climbingactivity) string {
	iter, err := dawa.NewReverseQuery("postnumre", climbingactivity.Lng, climbingactivity.Lat, "")
	if err != nil {
		fmt.Printf("Failed calling DAWA: %v", err)
		return ""
	}
